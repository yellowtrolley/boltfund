...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateDateRangeInput(oTable) {
        	...
        	var	labelFrom = $("<label />").attr("for", sFromId).attr("class", "section").append(aoFragments[0]).append(from);
        	var	labelTo = $("<label />").attr("for", sToId).attr("class", "section").append(aoFragments[2]).append(to);
            th.append(labelFrom).append(labelTo);
            ...
            th.wrapInner('<span class="filter_column filter_date_range cf" />');
            to.datepicker();
            var index = i;
            aiCustomSearch_Indexes.push(i);
